...
func collectServiceCheck(sc serviceCheck, i *integration.Integration, wg *sync.WaitGroup, outputTableName string) {
	...
	ms := e.NewMetricSet(outputTableName,
		attribute.Attribute{Key: "serverName", Value: serverName},
		attribute.Attribute{Key: "displayName", Value: sc.Name},
		attribute.Attribute{Key: "entityName", Value: "serviceCheck:" + sc.Name},
	)
